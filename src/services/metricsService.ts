...
import type { ExportedMetrics, EndpointStats } from '../types/metrics';
...
export const getMetricsSummary = () => {
  ...
  return {
    ...
    successRate: metrics.requestMetrics.totalRequests > 0
      ? ((metrics.requestMetrics.successfulRequests / metrics.requestMetrics.totalRequests) * 100).toFixed(1) + '%'
      : '0%',
